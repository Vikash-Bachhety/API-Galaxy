...
function Footer() {
  return (
    <div className="backGroundAnimate flex flex-col flex-wrap fixed bottom-0 left-0 min-w-full h-auto p-4 sm:p-0 lg:h-28 items-center pt-1 lg:pt-7 tracking-wider">
