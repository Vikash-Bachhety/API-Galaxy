  ...
  return (
    <div className="bg-gradient-to-r from-purple-500 to-sky-600 flex flex-col w-max-full w-min-sm border h-auto items-center mt-16 sm:mt-auto -z-10 left-0">
      ...
      <div className="text-sm md:text-xl flex flex-wrap justify-around h-auto w-max-xl xl:mt-20 w-min-sm lg:pt-5 border-none leading-6 sm:leading-loose tracking-widest">
        <h2 className="sm:shadow-black shadow-xl scrollLeft sm:w-sm xl:w-1/3 text-white sm:mt-14 h-1/4 p-3 xl:p-5 sm:p-8 font-serif hover:scale-95 transition-all duration-300">
        ...
        <div className="w-3/4 md:w-1/3 md:h-72 md:mb-40 h-1/4 mb-20">
          <h2 className="animate text-2xl xl:text-4xl mb-2 sm:mb-4 font-serif text-white font-solid">
            FEATURES
          </h2>
          <div className="shadow-black shadow-xl scrollRight flex flex-col pb-8 text-sm sm:text-2xl text-white font-semibold gap-y-2 text-center font-serif">
