...
function Converter() {
  ...
  return (
    <div className='bg-gradient-to-r from-purple-500 to-pink-500 flex flex-col sm:flex-row bg-center w-full bg-cover sm:h-[90vh] mt-12 sm:mt-8 font-serif tracking-wider'>
